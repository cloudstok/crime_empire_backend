...
export const prepareDataForWebhook = async (
    ...
    try {
        ...
        switch (key) {
            case 'DEBIT':
                obj.description = `${obj.amount} debited for Crime-Empire game for Round ${lobby_id}`;
                obj.bet_id = bet_id;
            ...
            case 'CREDIT':
                ...
                obj.description = `${final_amount} credited for Crime-Empire game for Round ${lobby_id}`;
                obj.txn_type = 1;
                break;
        }
